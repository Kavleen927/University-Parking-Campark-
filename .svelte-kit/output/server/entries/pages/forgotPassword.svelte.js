...
var forgotPassword_svelte_svelte_type_style_lang = "";
const css = {
  code: "#title.svelte-19yo9ye{text-align:center;font-weight:700}h1.svelte-19yo9ye{@apply font-semibold text-xl;}button.svelte-19yo9ye{@apply rounded-lg bg-pink-600 text-white w-full py-2 mt-2;}body.svelte-19yo9ye{@apply flex flex-col place-items-center place-content-center;}div.svelte-19yo9ye{@apply w-full max-w-xs flex flex-col gap-2;}input.svelte-19yo9ye{@apply w-full rounded p-1 border border-pink-500;}#back.svelte-19yo9ye{max-width:2.5rem;padding-top:0;padding-bottom:0}",
  map: null
};
...
const ForgotPassword = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let email, securityAChosen, newPassword;
  const securityQuestions = [
    {
      value: "Maiden name of your mother",
      label: "Maiden name of your mother",
      group: "Family"
    },
    {
      value: "The name of your first pet",
    ...
    {
      value: "Favorite food as a child",
      label: "Favorite food as a child",
      group: "Personal"
    },
    {
      value: "Month your best friend born was born",
      label: "Month your best friend was born",
      group: "Personal"
    },
    {
    ...
    {
      value: "Something you will never eat",
      label: "Something you will never eat",
      group: "Food"
    },
    {
      value: "What was your first job?",
    ...
    },
    {
      ...
      label: "Who is your favorite actor/actress?",
      group: "Personal"
    },
    {
      value: "The name of your favorite book?",
      label: "The name of your favorite book?",
      group: "Personale"
    }
  ];
  const groupBy = (question) => question.group;
  $$result.css.add(css);
  return `<body class="${"svelte-19yo9ye"}"><div class="${"svelte-19yo9ye"}"><br><br><br>
        <button id="${"back"}" class="${"svelte-19yo9ye"}">\u27F5</button>
        <h1 id="${"title"}" class="${"svelte-19yo9ye"}">Reset Password</h1>

        <p>Email</p>     
        <input type="${"text"}" class="${"svelte-19yo9ye"}"${add_attribute("value", email, 0)}>   


        <p>Security Question</p>   
        <div style="${"width:900px;"}" class="${"svelte-19yo9ye"}">${validate_component(Select, "Select").$$render($$result, { items: securityQuestions, groupBy }, {}, {})}</div>  

        <p>Answer</p>
        <input type="${"text"}" class="${"svelte-19yo9ye"}"${add_attribute("value", securityAChosen, 0)}>

        <p>New Password</p>
        <input type="${"password"}" class="${"svelte-19yo9ye"}"${add_attribute("value", newPassword, 0)}>
        
        <button class="${"svelte-19yo9ye"}">RESET</button>     </div>
</body>`;
});
