 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ao(t=Yi()){const e=Vt(t,"auth");return e.isInitialized()?e.getImmediate():nr(t,{popupRedirectResolver:zs,persistence:[es,jr,cn]})}$s("Browser");export{_t as $,go as A,jn as B,_n as C,yo as D,ho as E,On as F,j as G,Qs as H,Ys as I,wn as J,oo as K,bn as L,Tn as M,En as N,Ks as O,uo as P,vo as Q,ue as R,Gn as S,ro as T,bo as U,So as V,ko as W,Eo as X,wo as Y,Ao as Z,Ro as _,Nn as a,To as a0,eo as b,to as c,Pn as d,Cn as e,so as f,Js as g,Mn as h,zn as i,io as j,Xs as k,Zs as l,no as m,fo as n,Bn as o,po as p,Ut as q,lo as r,Pt as s,Ye as t,co as u,ao as v,_o as w,Io as x,Wn as y,mo as z};
